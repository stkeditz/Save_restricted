    ...
    async with gagan.conversation(event.chat_id) as conv: 
        try:
            ...
            cd = await conv.send_message("**Batch process ongoing...**\n\nProcess completed: ", 
                                    buttons=[[Button.url("Join Channel", url="https://t.me/group_adda_links")]])
            ...
            if int(fw.value) > 300:
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="https://t.me/group_adda_links")]])
        except Exception as e:
            #logger.info(e)
